...
print(f">>> arg parsed. dumpling args:")
...
print(f"device of generator: {generator.device}")
...
img, z, y = generator.optimize_clip_score(
    z_cllt,
    y_cllt,
    sentence,
    latent_noise=True,
...
if not os.path.exists("./samples"):
    os.mkdir("./samples")
save_image(
    img, "samples/fusedream_%s_seed_%d_score_%.4f.png" % (sentence, args.seed, score)
)
